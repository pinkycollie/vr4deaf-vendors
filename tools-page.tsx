...
const tierData = [
  {
    ...
    tools: [
      {
        icon: Users,
        title: "VR Counselor Matching System",
        description:
          "AI-powered matching system connecting deaf clients with culturally competent VR counselors based on communication preferences, location, and specialization areas.",
      },
      {
        icon: Calculator,
